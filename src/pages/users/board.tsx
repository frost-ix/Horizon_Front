    ...
    return (
      <div className="app">
        <form onSubmit={handleSubmit}>
          제목 : <input className="bg-gray-100 p-1 rounded-lg block placeholder:text-slate-400 focus:border-blue-400 focus:ring-blue-400 required" 
          ...
          <br />
          내용 : <input className="bg-gray-100 p-1 rounded-lg block placeholder:text-slate-400 focus:border-blue-400 focus:ring-blue-400 required" type="text-area" name="content" />
